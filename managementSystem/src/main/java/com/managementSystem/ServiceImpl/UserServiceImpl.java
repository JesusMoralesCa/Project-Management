package com.managementSystem.ServiceImpl;

import com.managementSystem.Constents.ProductConstants;
import com.managementSystem.DaoRepository.UserDao;
        ...
        try{
            if (validateSignUpMap(requestMap)){
                ...
                if (Objects.isNull(user)){
                    ...
                    return ProductUtils.getResposeEntity("Successfully Registeres", HttpStatus.OK);
                }else{
                    return ProductUtils.getResposeEntity("Email already exist", HttpStatus.BAD_REQUEST);
                }
            }else {
                return ProductUtils.getResposeEntity(ProductConstants.INVALID_DATA, HttpStatus.BAD_REQUEST);
            }
        }catch (Exception ex){
            ex.printStackTrace();
        }
